(function () {
    ...
    /* src/web-components/note.svelte generated by Svelte v3.49.0 */
    ...
    /* src/web-components/alert.svelte generated by Svelte v3.49.0 */
    ...
    // (315:8) {#if !(close === false || close === 'false')}
    ...
    // (293:8) {#if !(close === false || close === 'false')}
    ...
    // (289:6) <Note         id={`${id}-alert`}         title={title}       >
    ...
    /* src/web-components/image-gallery.svelte generated by Svelte v3.49.0 */
    ...
    class Image_gallery extends SvelteElement {
    	constructor(options) {
    		...
    		this.shadowRoot.innerHTML = `<style>:global([data-no-js]) .image-gallery .grid,:global([data-no-js]) :global(rf-image-gallery){--imageSize:calc(var(--largeSize) / 3) !important}.image-gallery .grid,:global(rf-image-gallery::part(grid)),:global([data-no-js]) :global(rf-image-gallery){display:grid;gap:var(--padding);grid-template-columns:repeat(auto-fit, minmax(min(var(--imageSize), 100%), 1fr));grid-template-rows:auto;justify-content:center;align-items:start}.image-gallery :global(:where(figure)),.image-gallery :global(:where(img)),:global(rf-image-gallery) :global(:where(figure)),:global(rf-image-gallery) :global(:where(img)){display:block;inline-size:100%;margin:0;aspect-ratio:1 / 1;-o-object-fit:cover;object-fit:cover;position:relative;inset-block-start:0;transition:var(--transitionSpeed)}.image-gallery :global(:where(figure):hover),.image-gallery :global(:where(figure):focus),.image-gallery :global(:where(img):hover),.image-gallery :global(:where(img):focus),:global(rf-image-gallery) :global(:where(figure):hover),:global(rf-image-gallery) :global(:where(figure):focus),:global(rf-image-gallery) :global(:where(img):hover),:global(rf-image-gallery) :global(:where(img):focus){inset-block-start:calc(-0.5 * var(--padding))}.image-gallery :global(:where(figure):hover) :global(img),.image-gallery :global(:where(figure):focus) :global(img),:global(rf-image-gallery) :global(:where(figure):hover) :global(img),:global(rf-image-gallery) :global(:where(figure):focus) :global(img){inset-block-start:0}.image-gallery dialog :global(figure):hover,.image-gallery dialog :global(figure):focus,.image-gallery dialog :global(img):hover,.image-gallery dialog :global(img):focus{inset-block-start:0}.image-gallery dialog,:is(*::part(dialog)){--buttonSize:calc(8 * var(--pixelSize));--imageBlockSize:calc(100vmin - (5 * var(--padding)));--imageInlineSize:calc(100vmin - (4 * var(--padding)) - (2 * var(--buttonSize)))
}.image-gallery dialog:empty,:is(*::part(dialog)):empty{pointer-events:none}.image-gallery dialog,:is(*::part(dialog)){box-sizing:border-box;border:none;background-color:transparent;block-size:100%;inline-size:100%;display:grid;padding:calc(0.5 * var(--padding));grid-template-columns:1fr fit-content(var(--imageInlineSize)) 1fr;grid-template-rows:1fr fit-content(calc(var(--imageBlockSize))) 1fr;grid-template-areas:". .     . "
    ". image . "
    ". .     . ";align-items:center;color:var(--colorText)

  /* :global is making this difficult, just put these styles twice */
}.image-gallery dialog :is(img),:is(*::part(dialog)) :is(img){filter:var(--imgFilter)}.image-gallery dialog :is(img, figure),:is(*::part(dialog)) :is(img, figure){grid-area:image;aspect-ratio:unset;-o-object-fit:unset;object-fit:unset;max-block-size:var(--imageBlockSize);max-inline-size:var(--imageInlineSize);block-size:auto;inline-size:auto;margin:0;text-align:center;background-color:var(--colorBackground);display:grid;grid-template-columns:fit-content(100%);grid-template-rows:1fr auto
  }.image-gallery dialog :is(img, figure) :is(img),:is(*::part(dialog)) :is(img, figure) :is(img){grid-column:1 / 2;grid-row:1 / 2;max-block-size:100% !important;margin-inline:auto}.image-gallery dialog :is(img, figure) :is(figcaption),:is(*::part(dialog)) :is(img, figure) :is(figcaption){grid-column:1 / 2;grid-row:2 / 3;display:block;max-inline-size:calc((2 * var(--padding) + var(--readableMax)));margin-inline:auto;color:var(--colorText);padding:var(--padding)}.image-gallery dialog :global(img),:is(*::part(dialog)) :global(img){filter:var(--imgFilter)}.image-gallery dialog :global(img),.image-gallery dialog :global(figure),:is(*::part(dialog)) :global(img),:is(*::part(dialog)) :global(figure){grid-area:image;aspect-ratio:unset;-o-object-fit:unset;object-fit:unset;max-block-size:var(--imageBlockSize);max-inline-size:var(--imageInlineSize);height:auto;width:auto;margin:0;text-align:center;background-color:var(--colorBackground);display:grid;grid-template-columns:fit-content(100%);grid-template-rows:1fr auto
  }.image-gallery dialog :global(img) :global(img),.image-gallery dialog :global(figure) :global(img),:is(*::part(dialog)) :global(img) :global(img),:is(*::part(dialog)) :global(figure) :global(img){grid-column:1 / 2;grid-row:1 / 2;max-block-size:100% !important;margin-inline:auto}.image-gallery dialog :global(img) :global(figcaption),.image-gallery dialog :global(figure) :global(figcaption),:is(*::part(dialog)) :global(img) :global(figcaption),:is(*::part(dialog)) :global(figure) :global(figcaption){grid-column:1 / 2;grid-row:2 / 3;display:block;max-inline-size:calc((2 * var(--padding) + var(--readableMax)));margin-inline:auto;color:var(--colorText);padding:var(--padding)}:global(body:not([data-no-js])) .image-gallery :global(figure),:global(body:not([data-no-js])) .image-gallery :global(img),:global(body:not([data-no-js])) :global(rf-image-gallery) :global(figure),:global(body:not([data-no-js])) :global(rf-image-gallery) :global(img){cursor:pointer}:global(body:not([data-no-js])) .image-gallery :global(figcaption),:global(body:not([data-no-js])) :global(rf-image-gallery) :global(figcaption){display:none}:global(body:not([data-no-js])) .image-gallery :global(dialog) :global(figcaption),:global(body:not([data-no-js])) :global(rf-image-gallery) :global(dialog) :global(figcaption){display:block}button{cursor:pointer;block-size:var(--buttonSize);inline-size:var(--buttonSize);padding:0;border:none;color:var(--colorText);position:relative;background-color:var(--colorBackground);grid-area:image;outline:calc(0.5 * var(--pixelSize)) solid var(--colorText)
}button::after{content:'';display:block;position:absolute;color:var(--colorText);inset-block-start:calc(1.5 * var(--pixelSize));inset-inline-end:calc(1.5 * var(--pixelSize));inset-block-end:calc(1.5 * var(--pixelSize));inset-inline-start:calc(1.5 * var(--pixelSize))}button[title='previous']{transform:rotate(var(--writingModeRotation)) scale(200%) scale(-1);justify-self:start;inset-inline-start:calc(-0.5 * var(--buttonSize))}button[title='next']{transform:rotate(var(--writingModeRotation)) scale(200%);justify-self:end;inset-inline-end:calc(-0.5 * var(--buttonSize))}button[title='previous']::after,button[title='next']::after{background:var(--pixelArrow);transition:0ms}button[title='previous']:hover::after,button[title='previous']:focus::after,button[title='next']:hover::after,button[title='next']:focus::after{background:var(--pixelArrowHover);transition:var(--transitionSpeedIcons)}button[title='close']{transform:scale(200%);align-self:start;justify-self:end;inset-block-start:calc(-0.5 * var(--buttonSize));inset-inline-end:calc(-0.5 * var(--buttonSize))
  }button[title='close']::after{background:var(--pixelX)}button[title='close']:hover::after,button[title='close']:focus::after{background:var(--pixelXHover);transition:var(--transitionSpeedIcons)}</style>`;
    ...
    /* src/web-components/tabs.svelte generated by Svelte v3.49.0 */
