...
<figure class="image--full">
  ...
  <figcaption>a user using the edit feature on the site</figcaption>
</figure>
...
Serving the site statically meant that I would need to trigger a build and a red-deploy any time a user added any new data. While it is possible to deploy a Sapper project in Node-mode to [Vercel](https://vercel.com/), I wanted to host this site on Netlify to avoid trying too many new things at once. Maybe next time I'll give Vercel a shot.
