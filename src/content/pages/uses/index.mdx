...
- I have a [Keycool 84](https://drop.com/buy/keycool-84-2s-mechanical-keyboard) mechancical keyboard with Cherry MX brown switches. They're tacticle enough and not _super_ loud, and I use as set of rubber gaskets to make them even more quiet. It's technically a Windows keyboard, but I swapped the keycaps and used [Karabiner](https://karabiner-elements.pqrs.org/) to switch the `command` and `option` key functionality and can't tell the difference on my Mac.
