import{S as c,i as u,s as m,k as f,q as l,l as h,m as b,r as i,h as d,b as y,G as p,H as g}from"../chunks/index.f98f3a93.mjs";const v=`<!-- ---
name: 'changes'
title: 'Changelog'
banner:
...
`;function w(o){let n,s,a,r;return{c(){n=f("pre"),s=l("  "),a=l(o[0]),r=l(`
`)},l(t){n=h(t,"PRE",{});var e=b(n);s=i(e,"  "),a=i(e,o[0]),r=i(e,`
`),e.forEach(d)},m(t,e){y(t,n,e),p(n,s),p(n,a),p(n,r)},p:g,i:g,o:g,d(t){t&&d(n)}}}const C=/<\!--(.|\s)*?-->/g;function k(o){return[v.replaceAll(C,"")]}class P extends c{constructor(n){super(),u(this,n,k,w,m,{})}}export{P as default};
